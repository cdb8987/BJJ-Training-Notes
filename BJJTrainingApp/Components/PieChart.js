...
export default function Piechart (props){
    ...
    // console.log('ChartData inside Piechart component is ')
    // chartData(dataToCount)
    ...
    useEffect(()=>{
      ...
      async function updateChartData(){
        ...
        console.log('inside useEffect chart Data is:', updatedData)
        ...
        // Then Sorts the array by highest to lowest. =>
        finalArray = finalArray.reverse()
        // Then Truncates the array at max 10 elements,.
